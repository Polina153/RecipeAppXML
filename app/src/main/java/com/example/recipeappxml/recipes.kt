...
object STUB{
    ...
    private val burgerRecipes = listOf(
        Recipe(
            ...
            ingredients = listOf(
                Ingredient(quantity = "0.5", unitOfMeasure = "кг", description = "говяжий фарш"),
                Ingredient(
                    quantity = "1.0",
                    unitOfMeasure = "шт",
                ...
                Ingredient(quantity = "4.0", unitOfMeasure = "шт", description = "листа салата"),
                Ingredient(
                    quantity = "1.0",
                    unitOfMeasure = "шт",
                    description = "помидор, нарезанный кольцами"
                ),
                Ingredient(quantity = "2.0", unitOfMeasure = "ст. л.", description = "горчица"),
                Ingredient(quantity = "2.0", unitOfMeasure = "ст. л.", description = "кетчуп"),
                Ingredient(
                    quantity = "по вкусу",
                    unitOfMeasure = "",
        ...
        Recipe(
            ...
            ingredients = listOf(
                Ingredient(quantity = "0.4", unitOfMeasure = "кг", description = "говяжий фарш"),
                Ingredient(
                    quantity = "4.0",
                    unitOfMeasure = "шт",
